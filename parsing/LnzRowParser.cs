...
class LnzRowParser
{
    ...
    public void Test()
    {
        ...
        if (X != .25f)
        {
            Console.WriteLine("Parsing .25 failed");
        }

        rp.Float(ref X);
        if (X != .125f)
        {
            Console.WriteLine("Parsing 0.125 failed");
        }

        rp.Float(ref X);
        if (X != 123456f)
        {
            Console.WriteLine("Parsing 123456f failed");
        }

        rp.Float(ref X);
        if (X != 123.125f)
        {
            Console.WriteLine("Parsing 123.125 failed");
        }
    }
};